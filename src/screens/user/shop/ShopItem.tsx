...
const ShopItemScreen: React.FC<RegisterScreenProps> = ({ route, navigation }) => {
	return (
		<View style={styles.container}>
			<View style={{ flex: 1 }}>
				<Image style={styles.imagen} source={require('../../../../assets/images/Resto.jpg')} />
			</View>
			...
			<View style={{ flex: 2 }}>
				<ScrollView>
					<View style={{ flex: 1, flexDirection: 'row' }}>
						...
						<View style={{ flex: 0.5 }}>
							<Image style={styles.imagen} source={require('../../../../assets/images/LibreGluten.png')} />
						</View>

						<View style={{ flex: 0.5 }}>
							<Image style={styles.imagen} source={require('../../../../assets/images/Vegano.png')} />
						</View>
