...
const Perfil_Restaurante = (props) => {
  return (
    <View style = {styles.container}>
      ...
      <View style = {{flex: 1}}>
        <TouchableOpacity style={styles.buttonCerrarSesion} onPressOut={() => Alert.alert('Se ha cerrado la sesión correctamente.')} onPress={() => props.navigation.navigate('Login Restaurante')}>
  ...
  export default Perfil_Restaurante;