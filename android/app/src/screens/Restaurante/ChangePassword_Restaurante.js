...
const ChangePassword_Restaurante = (props) => {
    return (    
        ...
        <View style = {styles.container}>
          ...
          <View style = {{flex: .5}}>
            <TouchableOpacity style = {styles.buttonGuardar} onPress={() => props.navigation.navigate('Login Restaurante')}>
...
export default ChangePassword_Restaurante;